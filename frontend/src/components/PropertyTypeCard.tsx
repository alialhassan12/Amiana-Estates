        ...
        <div className="flex flex-col items-center bg-[#F4F3F0] group">
            <div className="w-full h-[500px] overflow-hidden">
                <img 
                    ...
                    src={propertyType.image_url} alt="" 
                />
            </div>
            <div className="flex flex-col items-start w-full py-5 px-10 gap-4">
                <p className="body-text tracking-widest text-primary uppercase text-xs">
                    ...
                    {/* discover button */}
                    <button className="flex flex-row items-center gap-2 text-sm uppercase mt-8 tracking-widest text-black hover:text-primary transition-all duration-300 cursor-pointer group/discover-btn">
